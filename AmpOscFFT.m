function [ PercArtifact, CorticalFFTdata ] = AmpOscFFT( Data, HighCF, LowCF, Fs, ArtifactThreshold, FiltOrd )
...
for c = 1:channels
    for z = 1:trials
        ...
        [b,a] = butter(1, (.25/nyqu) ,'high');
        EEGfilteredEnv(:,c,z) = filter(b,a,EEGfilteredEnv(:,c,z));
    end
end

%% Averaging

%EEGfilteredAvg = nanmean(EEGfiltered,3);
