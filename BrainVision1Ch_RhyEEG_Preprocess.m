function [ filteredEEGdata, Fs ] = BrainVision1Ch_RhyEEG_Preprocess(vhdrName, ContainingPath)
...
gain = 50;  % Gain of the pre-amp. The waveform amplitudes are later scaled down by this factor. 
