function varargout = STpeakfinder(x0, sel, thresh, extrema, includeEndpoints, interpolate)
...
if nargin < 2 || isempty(sel)
     sel = (max(x0)-min(x0))/2; %modified to be less strict
     %sel = (max(x0)-min(x0))/4; %ORIGINAL CODE
