function [topchans,top5] = FULLCorticalFFT_Avg5PLOT( CorticalFFTdata, Fs )
%UNTITLED Summary of this function goes here
%   Detailed explanation goes here

% Plot single-sided amplitude spectrum.
              % Time vector
NFFT = size(CorticalFFTdata,1); % length of y
...
for s = 1:size(CorticalFFTdata,3)
    ...
    goodChans
    [sortedX,sortingIndices] = sort(NormedFFTData(index2Hz,goodChans,s),'descend');
