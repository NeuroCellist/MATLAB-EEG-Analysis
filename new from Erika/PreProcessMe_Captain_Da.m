...
[hdrfile, path] = uigetfile('C:\Users\SkoeLab\Data\*da*.vhdr', 'Pick a Da file'); % loads up browse window where you can select the file to run.
...
prestim =  40;  % in ms (assumes a negative number, i.e. 10 = 10 ms before the stimulus).
poststim = 180; %in ms
analysisend =160; % end of response window.  Used to perform SNR calculations.
numtrials = 4000;  
