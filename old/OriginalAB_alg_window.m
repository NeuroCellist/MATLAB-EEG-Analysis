function  CleanEEG = OriginalAB_alg_window(EEGdata,fs,threshold,approach)
...
elseif strncmp(approach,'window',5)
    LWind = fix(2*fs);  %window of 2 seconds [you can change the window length from this line]
else
